...
## EFA with 2 factors
```{r}
f2 = fa(poly, nfactors = 2, rotate = "oblimin", residuals = T, SMC = T, fm = "pa", n.obs = 2561)
...
## EFA with 3 factors
```{r}
f3 = fa(poly, nfactors = 3, rotate = "oblimin", residuals = T, SMC = T, fm = "pa", n.obs = 2561)
...
## EFA with 4 factors
```{r}
f4 = fa(poly, nfactors = 4, rotate = "oblimin", residuals = T, SMC = T, fm = "pa", n.obs = 2561)
